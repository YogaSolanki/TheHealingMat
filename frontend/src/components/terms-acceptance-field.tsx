...
export function TermsAcceptanceField({
  ...
  return (
    <label
      htmlFor={id}
      className="flex cursor-pointer items-start gap-2.5 rounded-[14px] border border-[#e2e8df] bg-[#f7faf7] px-3.5 py-3 text-left"
    >
      <input
        id={id}
        type="checkbox"
      ...
      />
      <span className="text-[12px] leading-relaxed text-[#3d4a3c] sm:text-[13px]">
        I agree to the{" "}
        <Link
          href="/terms"
          target="_blank"
