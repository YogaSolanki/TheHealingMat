...
export function SiteFooter() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto grid w-full max-w-[1200px] grid-cols-2 gap-x-4 gap-y-8 px-5 py-8 sm:gap-x-6 sm:px-6 sm:py-9 lg:grid-cols-4 lg:gap-0 lg:px-8 lg:py-9 xl:px-10">
        <div className="col-span-2 flex flex-col items-start text-left lg:col-span-1 lg:pr-6 xl:pr-8">
        ...
        <div className="min-w-0 lg:border-l lg:border-[#dde3d8] lg:px-6 xl:px-8">
        ...
        <div className="col-span-2 min-w-0 sm:col-span-1 lg:border-l lg:border-[#dde3d8] lg:pl-6 xl:pl-8">
          <h3 className="text-[14px] font-bold text-[#1f6b3a] sm:text-[15px]">
            Contact Us
          </h3>
      ...
      <div className="border-t border-[#d9e0d4] bg-[#1f6b3a]">
        <div className="mx-auto flex w-full max-w-[1200px] flex-col items-center gap-3 px-5 py-4 text-center sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:gap-4 lg:px-8 lg:py-3 lg:text-left xl:px-10">
          <p className="text-[12px] text-[#d7e2d8]">
            © {new Date().getFullYear()} The Healing Mat. All Rights Reserved.
          </p>

          <ul className="flex max-w-[420px] flex-wrap items-center justify-center gap-x-3 gap-y-1.5 text-[12px] sm:max-w-none lg:gap-x-0">
